#!/usr/bin/env bash
# =====================================================================
# WEB-Interia - automaticky start pre GitHub Codespaces
# Spusta sa cez postStartCommand (kazdy start kontajnera)
# a postAttachCommand (kazde otvorenie/attach codespace).
# Skript je IDEMPOTENTNY - bezpecne ho mozno spustit opakovane.
# Zabezpeci:
#   1. PHP runtime (doinstaluje, ak chyba)
#   2. Bezici Laravel server na 0.0.0.0:8000
#   3. Verejny (public) port 8000
#   4. Vypis verejnej URL stranky
# =====================================================================
...
# --- 2) Laravel server ------------------------------------------------
# Ukonci pripadny nespravny server na nasom porte (napr. python http.server).
...
# --- 4) Verejny port + URL (len v Codespaces) -------------------------
...
# Auto-forward portu moze meskat - visibility skusame opakovane.
